...
def fetch_tide_data(tide_url):
    ...
    tr_results = tide_table.find_all('tr')
...
def format_sun_time(sun_time):
    """
    Convert a time string from the sunrise-sunset API into a formatted string in local time.
    """
...
def get_sun_times(cdate):
    """
    Fetch the sunrise and sunset times for a given date, and return them as formatted strings.
    """
